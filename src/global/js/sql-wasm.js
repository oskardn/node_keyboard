    ...
    initSqlJsPromise = new Promise(function (resolveModule, reject) {
        ...
        e.onRuntimeInitialized = function () {
            ...
            function c(h) {
                ...
                if (null != h) {
                    ...
                    if (h) {
                        if ("string" === typeof h) {
                            for (
                                var p = Array(h.length), z = 0, N = h.length;
                                z < N;
                                ++z
                            )
                                p[z] = h.charCodeAt(z);
            ...
            var d = x(4),
                ...
                jc = f("sqlite3_bind_double", "number", [
                    "number",
                    "number",
                    "number",
                ]),
                kc = f("sqlite3_bind_int", "number", [
                    "number",
                    "number",
                    "number",
                ]),
                lc = f("sqlite3_bind_parameter_index", "number", [
                    "number",
                    "string",
                ]),
            ...
            if (Ja.has(a)) a = Ja.get(a);
                ...
                try {
                    ...
                    if ("function" === typeof WebAssembly.Function) {
                        ...
                        c = new WebAssembly.Instance(c, { e: { f: a } }).exports
                            .f;
                    }
                    J.set(b, c);
                }
        ...
        function Tc(a, b, c) {
            ...
            L = [
                ...
                1 <= +Math.abs(M)
                    ? 0 < M
                        ? (Math.min(+Math.floor(M / 4294967296), 4294967295) |
                              0) >>>
                          0
        ...
        var ad = {
            a: function (a, b, c, d) {
                F(
                    "Assertion failed: " +
                        ...
                        ", at: " +
                        [
                            b ? A(b) : "unknown filename",
                            c,
                            d ? A(d) : "unknown function",
                        ]
                );
            },
            s: function (a, b) {
            ...
            y: function (a, b) {
                try {
                    ...
                    return (
                        ("undefined" !== typeof Y && f instanceof Q) || F(f),
                        -f.Pa
                    );
                }
            },
            i: function (a, b) {
                try {
                    ...
                    return (
                        ("undefined" !== typeof Y && c instanceof Q) || F(c),
                        -c.Pa
                    );
                }
            },
            z: function (a) {
                try {
                    ...
                    return (
                        ("undefined" !== typeof Y && b instanceof Q) || F(b),
                        -b.Pa
                    );
                }
            },
            j: function (a, b) {
                try {
                    ...
                    return (
                        ("undefined" !== typeof Y && d instanceof Q) || F(d),
                        -d.Pa
                    );
                }
            },
            ...
            b: function (a, b, c) {
                ...
                try {
                    ...
                    return (
                        ("undefined" !== typeof Y && g instanceof Q) || F(g),
                        -g.Pa
                    );
                }
            },
            ...
            t: function (a, b, c, d, f, g) {
                try {
                    ...
                    return (
                        ("undefined" !== typeof Y && ba instanceof Q) || F(ba),
                        -ba.Pa
                    );
                }
            },
            u: function (a, b) {
                try {
                    ...
                    return (
                        ("undefined" !== typeof Y && w instanceof Q) || F(w),
                        -w.Pa
                    );
                }
            },
            ...
            F: function (a, b, c) {
                try {
                    ...
                    return (
                        ("undefined" !== typeof Y && t instanceof Q) || F(t),
                        -t.Pa
                    );
                }
            },
            ...
            w: function (a, b, c, d) {
                try {
                    ...
                    return (
                        ("undefined" !== typeof Y && u instanceof Q) || F(u),
                        u.Pa
                    );
                }
            },
            m: function (a, b, c, d, f) {
                try {
                    ...
                    return (
                        ("undefined" !== typeof Y && m instanceof Q) || F(m),
                        m.Pa
                    );
                }
            },
        ...
        e._sqlite3_normalized_sql = function () {
            return (e._sqlite3_normalized_sql = e.asm.ta).apply(
                null,
                arguments
            );
        };
        ...
        e._sqlite3_create_function_v2 = function () {
            return (e._sqlite3_create_function_v2 = e.asm.ya).apply(
                null,
                arguments
            );
        };
        ...
        e._RegisterExtensionFunctions = function () {
            return (e._RegisterExtensionFunctions = e.asm.Da).apply(
                null,
                arguments
            );
        };
        var ob = (e.__get_tzname = function () {
            ...
            nb = (e.__get_daylight = function () {
                return (nb = e.__get_daylight = e.asm.Fa).apply(
                    null,
                    arguments
                );
            }),
            mb = (e.__get_timezone = function () {
                return (mb = e.__get_timezone = e.asm.Ga).apply(
                    null,
                    arguments
                );
            }),
