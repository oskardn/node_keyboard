...
Pensez à lire les prérequis en fonction de votre système d'exploitation avant d'installer la librairie `sendinput` avant de lancer le script.  [Lien vers la documentation](https://www.npmjs.com/package/node-gyp#installation)
